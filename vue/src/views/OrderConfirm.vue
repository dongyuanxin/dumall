        ...
        <div class="checkout-order">
          ...
          <div class="order-foot-wrap">
            <div class="prev-btn-wrap">
              ...
              <router-link class="btn btn--m" to="/address">Privous</router-link>
            </div>
...
<script>
  ...
  export default {
    ...
    computed:{
      orderTotal(){
        let total = this.shipping + this.tax - this.discount;
    ...
    methods:{
      ...
      payMent(){
        let addressId = this.$route.query.addressId; // 获得网址参数是route
