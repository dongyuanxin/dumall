<template>
  <div>
        ...
        <div class="cart-foot-wrap">
          <div class="cart-foot-inner">
            ...
            <div class="cart-foot-r">
              ...
              <div class="btn-wrap">
                <a class="btn btn--red" :class="{'btn--dis':checkedCount===0}" @click.stop="checkOut">Checkout</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <modal :mdShow = "modalConfirm" @close="closeModal()">
      ...
      <div slot="btnGroup" >
        <a class="btn btn--m" @click="delCart" href="javascript:void(0)">确认</a>
        <a class="btn btn--m" @click="modalConfirm = false" href="javascript:void(0)">关闭</a>
      </div>
    </modal>
...
<script>
  ...
  export default {
    ...
    computed:{
      checkAllFlag :{ // checkAllFlag 依赖于 cartList
        get:function() {
    ...
    watch:{
      cartList:{
        handler:function () {
          console.log("Change thing's number");
        },
        deep:true
      }
    }
